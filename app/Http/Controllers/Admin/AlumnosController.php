...
class AlumnosController extends Controller
{
    ...
    public function Alums(Request $request)
    {
        ...
        return redirect('/alumnos')->with('status', 'El Alumnos se Guardo Correctamente');
    }
    ...
    return redirect('alumnos')->with('status','El Alumno de Actualizo Correctamente');
    ...
    public function delete($id){
        ...
        return redirect('alumnos')->with('status','El Alumno se Elimino Correctamente');
    }
}
